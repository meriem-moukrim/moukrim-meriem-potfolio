...
const StyledProject = styled.li`
  ...
  .project-fullscreen-inline-trigger {
    background: transparent;
    border: none;
    color: var(--lightest-slate);
    padding: 10px;
    margin-left: -10px; /* Offset padding to align with text */
    cursor: pointer;
    display: flex;
    align-items: center;
    transition: var(--transition);
        ...
        edges {
          node {
            frontmatter {
              ...
              tech_icons {
                childImageSharp {
                  gatsbyImageData(width: 30, placeholder: BLURRED, formats: [AUTO, WEBP, AVIF])
                }
              }
              github
              external
      ...
      <StyledProjectsGrid>
        {featuredProjects &&
          featuredProjects.map(({ node }, i) => {
            ...
            const { external, title, tech, tech_icons, github, cover, fullscreen } = frontmatter;
            ...
            return (
              <StyledProject key={i} ref={el => (revealProjects.current[i] = el)}>
                <div className="project-content">
                  <div>
                    <p className="project-overline">Full-Stack</p>
                    ...
                    {tech_icons && tech_icons.length > 0 ? (
                      <ul className="project-tech-list icons">
                        ...
                        {/* Optionally add text for tech without icons, but the user asked to replace them */}
                      </ul>
                    ) : (
                      tech.length && (
